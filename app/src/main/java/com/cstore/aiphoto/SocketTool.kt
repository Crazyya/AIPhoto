 ...
 * on 2022/2/17 16:04.
 */
class SocketTool(private var scope: CoroutineScope, private var host: String, private val msg: MutableLiveData<String>, private val state: MutableLiveData<String>) {
